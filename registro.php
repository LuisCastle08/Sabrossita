	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="php/RegUser.php" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Se requiere un nombre de usuario">
						<input class="input100" type="text" name="apellido" placeholder="Apellido" autocomplete="off">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-user" aria-hidden="true"></i>
						</span>
					...
					<div class="wrap-input100 validate-input" data-validate = "Se requiere  10 caracteres">
						<input class="input100" type="tel" name="celular" placeholder="(+#)Numero de celular" autocomplete="off">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
					...
					<div class="container-login100-form-btn">
						<button type="submit" name="registro" class="login100-form-btn">
							Registrate
						</button>
					</div>
