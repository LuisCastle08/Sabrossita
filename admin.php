          ...
          <div class="col-md-12">
            <div class="tile">
              <div class="table-responsive" style="background-color:#fff ;">
                <table class="table">
                  <thead>
                    <h2>Tabla de Pedidos en Proceso</h2>
                    <tr>
                      <th>N° Pedido</th>
                      <th>N° Cliente</th>
                  ...
                  <tbody>
                  <?php
                      $consulta_mysqli = "SELECT * FROM pedidos WHERE proceso='PROCESO' ORDER BY `id` DESC";
                    ...
                    <tr>
                      ...
                      <td>
                      <a class="btn btn-danger" href="php/cam_proceso.php?id_user=<?php echo $id?>">Entregado</a>
                      </td>
                      <td>
